...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">AHSA</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'admin-profile' ? 'active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Administrator Profile</span>
                </a>
            </li>
            <!-- User Management sidebar item -->
{{-- <li class="nav-item">
...
<li class="nav-item mt-3">
 ...
 <li class="nav-item">
    <a class="nav-link text-white {{ $activePage == 'adminDashboard' ? 'active bg-gradient-primary' : '' }}" href="{{ route('adminDashboard') }}">
        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link text-white {{ $activePage == 'admin_assignments' ? ' active bg-gradient-primary' : '' }} "
                href="{{ route('admin_assignments')}}" >
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
